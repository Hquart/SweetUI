////
////  CKResourceService2.swift
////  SweetUI
////
////  Created by Naji Achkar on 07/03/2022.
//
//
//import Foundation
//import SwiftUI
...
//
//class CKRessourceService2: ObservableObject {
//    
...
//        newSwiftItem["creator"] = userModel.userName + " " + userModel.familyName
//        
...
//                          let creator = record["creator"] as? String else { return }
//             
//                  
//                    let designImageAsset = record["designImage"] as? CKAsset
//                    let designImageUrl = designImageAsset?.fileURL
//             
//                    returnedItems.append(SwiftItem(type: type, designImage: designImageUrl, code: code, record: record, creator: creator))
//                                         
